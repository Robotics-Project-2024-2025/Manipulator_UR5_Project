...
static const _Vector3d_type_support_symbol_names_t _Vector3d_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, move_ws, msg, Vector3d)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, move_ws, msg, Vector3d)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, move_ws, msg, Vector3d)() {
  return &::move_ws::msg::rosidl_typesupport_c::Vector3d_message_type_support_handle;
}
