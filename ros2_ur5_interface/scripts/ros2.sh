...
docker run --rm -d -v ~/Manipulator_UR5_Project:/home/ubuntu/ros2_ws/src/Manipulator_UR5_Project -p 6081:80 -p 50002:50002 --security-opt seccomp=unconfined --shm-size=512m --net ursim_net --ip 192.168.56.200 --name ros2 pla10/ros2_ur5_interface
